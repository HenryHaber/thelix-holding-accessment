      ...
      <Box>
        {loading ? <Loading /> :  (
           ...
           <div className="flex justify-between items-center mb-4 flex-wrap gap-4">
            <div className="block">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800">Nitendo</h2>
            <div className="flex items-center text-gray-500">
            <Link href="#" className="flex items-center"><Image height={50} width={50} src='/images/category.svg'/> Dashboard</Link>
            <FaChevronRight />
            <Link href="#" className="flex items-center text-black"><HiUsers/> Nintento</Link>
            </div>
            </div>
             <button className="bg-[#B02A2A] text-white px-4 py-2 rounded-md text-sm font-semibold">New Request</button>
           </div>
